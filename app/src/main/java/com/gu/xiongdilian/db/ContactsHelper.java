...
import com.gu.xiongdilian.pojo.citylist.PinyinBaseUnit;
import com.gu.xiongdilian.pojo.citylist.PinyinUnit;
import com.gu.xiongdilian.utils.citylist.PinyinUtil;
import com.gu.xiongdilian.utils.citylist.QwertyMatchPinyinUnits;
import com.gu.xiongdilian.utils.citylist.T9MatchPinyinUnits;
...
public class ContactsHelper {
    ...
    public void parseT9InputSearchContacts(String search) {
        List<Contacts> mSearchByNameContacts = new ArrayList<>();
    ...
    private void initContactsHelper() {
        mContext = XiongDiLianApplication.getInstance().getApplicationContext();
        ...
        if (null == mSelectedContactsHashMap) {
            mSelectedContactsHashMap = new HashMap<>();
        } else {
            mSelectedContactsHashMap.clear();
        }
    }
