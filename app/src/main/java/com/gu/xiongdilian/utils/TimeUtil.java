...
public class TimeUtil {
    ...
    public static String getDescriptionTimeFromTimestamp(long timestamp) {
        long currentTime = 0;
        if (TextUtils.isEmpty(XiongDiLianApplication.SERVER_TIME)) {
            currentTime = System.currentTimeMillis();
        } else {
            currentTime = stringToLong(XiongDiLianApplication.SERVER_TIME, FORMAT_DATE_TIME_SECOND);
        }
