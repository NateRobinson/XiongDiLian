    ...
    private CharSequence replace(String text) {
        try {
            ...
            while (matcher.find()) {
                ...
                Bitmap bitmap =
                        BitmapFactory.decodeResource(getContext().getResources(), getContext().getResources()
                                .getIdentifier(key, "drawable", getContext().getPackageName()), options);
